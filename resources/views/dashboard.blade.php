                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                        <div class="card shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title text-muted">Investment Ammount</h5>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                        <div class="card shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-bold-600">{{ $percentageGain }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                        <div class="card shadow-sm">
                            <div class="card-body text-center">
                                <div class="icon-container mb-3">
                                    <i class="feather icon-briefcase font-large-2 text-success"></i>
                                </div>
                                <h5 class="card-title text-muted">profit/Loss </h5>
                                <h3>{{ $profitOrLossLabel }}: ₹{{ $absoluteProfitOrLoss }}</h3>
                                <span class="text-success">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Bar Chart for Mutual Fund Performance
        ...
        var pieChart = new Chart(pieCtx, {
            type: 'pie',
            data: {
                labels: ['HDFC', 'TATA', 'TCS', 'ADANI', 'NIPON INDIA'],
                datasets: [{
                    data: [40, 25, 15, 10, 10], // Percentage distribution
